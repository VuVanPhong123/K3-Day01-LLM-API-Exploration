...
OPENAI_MODEL = os.getenv("LAB_MODEL", "gemini-3.1-flash-lite")
OPENAI_MINI_MODEL = os.getenv("LAB_MINI_MODEL", OPENAI_MODEL)


def _client_kwargs() -> dict:
    """Return OpenAI SDK client kwargs for either Gemini or OpenAI-compatible APIs."""
    ...
    if gemini_key and not base_url:
